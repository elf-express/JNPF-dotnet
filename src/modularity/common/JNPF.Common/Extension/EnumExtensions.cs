...
public static class EnumExtensions
{
    ...
    /// <summary>
    /// 获取枚举的ErrorCodeItemMetadata.
    /// </summary>
    /// <param name="value"></param>
    /// <returns></returns>
    public static string GetErrorCodeItemMetadata(this ErrorCode value)
    {
        return value.GetType().GetField(value.ToString()).GetCustomAttribute<ErrorCodeItemMetadataAttribute>()?.ErrorMessage;
    }
